...
export default function AdminDashboard() {
    ...
    const prepareBathhouseData = () => {
        return {
            ...
            bonus_threshold_amount: bathhouseDetails.bonus_threshold_amount,
            lower_bonus_percentage: bathhouseDetails.lower_bonus_percentage,
            higher_bonus_percentage: bathhouseDetails.higher_bonus_percentage,
            bonus_accrual_enabled: bathhouseDetails.bonus_accrual_enabled,
            happy_hours_enabled: bathhouseDetails.happy_hours_enabled,
            birthday_discount_enabled: bathhouseDetails.birthday_discount_enabled,
            bonus_hour_enabled: bathhouseDetails.bonus_hour_enabled,
            happy_hours_start_time: bathhouseDetails.happy_hours_start_time || null,
            happy_hours_end_time: bathhouseDetails.happy_hours_end_time || null,
            happy_hours_discount_percentage: bathhouseDetails.happy_hours_discount_percentage,
            happy_hours_days: bathhouseDetails.happy_hours_days,
            birthday_discount_percentage: bathhouseDetails.birthday_discount_percentage,
            min_hours_for_bonus: bathhouseDetails.min_hours_for_bonus,
            bonus_hour_days: bathhouseDetails.bonus_hour_days,
            bonus_hours_awarded: bathhouseDetails.bonus_hours_awarded,
    ...
    const handleUpdateBathhouse = (bathhouse) => {
        ...
        setBathhouseDetails({
            ...
            bonus_threshold_amount: bathhouse.bonus_threshold_amount,
            lower_bonus_percentage: bathhouse.lower_bonus_percentage,
            higher_bonus_percentage: bathhouse.higher_bonus_percentage,
            bonus_accrual_enabled: bathhouse.bonus_accrual_enabled,
            happy_hours_enabled: bathhouse.happy_hours_enabled,
            birthday_discount_enabled: bathhouse.birthday_discount_enabled,
            bonus_hour_enabled: bathhouse.bonus_hour_enabled,
            happy_hours_start_time: bathhouse.happy_hours_start_time,
            happy_hours_end_time: bathhouse.happy_hours_end_time,
            happy_hours_discount_percentage: bathhouse.happy_hours_discount_percentage,
            happy_hours_days: Array.isArray(bathhouse.happy_hours_days) ? bathhouse.happy_hours_days : [],
            birthday_discount_percentage: bathhouse.birthday_discount_percentage,
            min_hours_for_bonus: bathhouse.min_hours_for_bonus,
            bonus_hour_days: Array.isArray(bathhouse.bonus_hour_days) ? bathhouse.bonus_hour_days : [],
            bonus_hours_awarded: bathhouse.bonus_hours_awarded,
